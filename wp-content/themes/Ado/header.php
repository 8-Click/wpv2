...
<head>
    ...
    <?php $styles = ["news", "merch", "discography", "home", "hall-of-fame"];
    if (isset($styles)) : ?>
...
<body>
    <nav id="navbar">
        <a href="" class="logo-link">
            <img src="<?=get_template_directory_uri()?>/assets/img/branding/ado_logo_text.png" alt="" class="logo">
        </a>
        <ul class="nav-links">
            <li class="nav-link"><a href="discography.php">Discography</a>
                <button onclick="showMore(this)" class="show-more-btn">
                    <img src="<?=get_template_directory_uri()?>/assets/img/icons/arrow_forward.svg" alt="" class="show-more-icon">
                </button>
